  ...
  return (
    <section className='bg-white py-16 p-4'>
       ...
       <p className='bg-[#ffe8d9] text-[#ff6300] rounded-md mx-auto p-2 ml-0'>How we work</p>
         ...
         <p>Limitless Leadership Eversion (LLE) is  a non-profit organization dedicated  to developing young adults into  capable, effective, and efficient  leaders across all social systems.</p>
