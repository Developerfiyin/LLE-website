         ...
         delivered to your mail</h3>
          ...
          <div className='flex gap-3 justify-center'>
           <input type="text" placeholder='Enter your email address'
            className='pl-7 pr-3 py-2 w-70 border border-gray-700 rounded-lg focus:ring-2 focus:ring-[#ff6300] focus:outline-none' />
        <button className='bg-[#a60000] text-white p-2 w-50 rounded-lg ease-in-out duration-300 hover:bg-[#3a0000]'>Register Now</button>
