...
const Hero = () => {
  ...
  return (
    <div className='bg-cover h-screen relative gap-10 bg-center text-center flex justify-center flex-col py-16 '  style={{ backgroundImage: `url(${Frame15})` }}>
    <div className='w-90 font-montserrat flex text-center mt-100 '>    
